  ...
  return (
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-background/80 dark:bg-background/90 backdrop-blur-lg border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 cursor-pointer flex-shrink-0" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            ...
            <span className="text-xl sm:text-2xl font-bold text-foreground">BenchBridge</span>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2 sm:py-2.5 bg-primary hover:bg-primary-hover text-white font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-blue-600/25 text-sm"
            >
              Login
            </button>
            {/* Mobile Hamburger */}
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-border bg-background/95 backdrop-blur-lg">
            <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col gap-1">
              <button onClick={() => scrollToSection('features')} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors text-left py-3 border-b border-border/50">
                Features
              </button>
              <button onClick={() => scrollToSection('solutions')} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors text-left py-3 border-b border-border/50">
                Solutions
              </button>
              <button onClick={() => scrollToSection('pricing')} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors text-left py-3">
                Pricing
              </button>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-green-800 dark:from-slate-950 dark:via-blue-950 dark:to-green-950 relative overflow-hidden min-h-[calc(100vh-4rem)] flex flex-col justify-center">
        ...
        {/* Hero Section */}
        <section className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-16">
            ...
            <div className="space-y-6 lg:space-y-8 lg:pr-8">
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
                <button
                  ...
                  className="group px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-semibold rounded-xl transition-all duration-300 shadow-2xl shadow-blue-500/50 hover:scale-105 flex items-center gap-2 text-sm sm:text-base"
                >
                ...
                <button
                  onClick={onLoginClick}
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white font-semibold rounded-xl transition-all duration-200 border border-white/20 hover:border-white/40 text-sm sm:text-base"
                >
                  Login
                </button>
              </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-all">
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">3 submissions/mo</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">Basic search</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">No billing</span>
                </li>
              </ul>
              <button className="w-full h-11 sm:h-12 px-6 border border-border rounded-lg hover:bg-secondary transition-all font-medium text-foreground text-sm sm:text-base">
                Choose
              </button>
            </div>

            {/* Basic Plan - Popular */}
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 border-2 border-blue-500 rounded-2xl p-6 sm:p-8 relative shadow-2xl shadow-blue-600/30 lg:scale-105">
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-white text-sm sm:text-base">20 submissions/mo</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-300 flex-shrink-0 mt-0.5" />
                  <span className="text-white text-sm sm:text-base">Advanced filters</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-300 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-300 flex-shrink-0 mt-0.5" />
                  <span className="text-white text-sm sm:text-base">Analytics</span>
                </li>
              </ul>
              <button className="w-full h-11 sm:h-12 px-6 bg-white text-blue-600 rounded-lg hover:bg-blue-50 transition-all font-semibold shadow-xl text-sm sm:text-base">
                Choose
              </button>
            </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-all">
              <div className="mb-5 sm:mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2">Premium</h3>
                <p className="text-muted-foreground text-sm">For large enterprises</p>
              </div>
              <div className="mb-6 sm:mb-8">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl sm:text-5xl font-bold text-foreground">₹9,999</span>
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">Unlimited submits</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">Priority access</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">Dedicated account</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">Custom reports</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-foreground text-sm sm:text-base">API access</span>
                </li>
              </ul>
              <button className="w-full h-11 sm:h-12 px-6 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all font-semibold shadow-lg shadow-purple-600/30 text-sm sm:text-base">
                Choose
              </button>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-primary via-blue-600 to-blue-700 dark:from-blue-900 dark:via-blue-800 dark:to-blue-900 rounded-3xl p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
              <button
                onClick={onGetStartedClick}
                className="px-8 sm:px-10 py-3 sm:py-4 bg-white text-primary hover:bg-gray-100 font-semibold rounded-xl transition-all duration-200 shadow-2xl flex items-center gap-2 text-sm sm:text-base"
              >
              ...
              <button
                onClick={onLoginClick}
                className="px-8 sm:px-10 py-3 sm:py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl transition-all duration-200 backdrop-blur-sm border border-white/20 text-sm sm:text-base"
              >
                Sign In Now
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-green-500 rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/30">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L2 7L12 12L22 7L12 2Z" fill="white" />
                    <path d="M2 17L12 22L22 17" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M2 12L12 17L22 12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
