import { LayoutDashboard, Users, FileText, ChevronLeft, ChevronRight, Briefcase } from 'lucide-react';
...
export function VendorSidebar({ currentPage, onNavigate, isCollapsed, onToggleCollapse }: VendorSidebarProps) {
  const menuItems = [
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-screen bg-gradient-to-b from-purple-50 via-white to-purple-50 dark:from-purple-900/20 dark:via-slate-950 dark:to-purple-900/20 border-r border-purple-200/60 dark:border-purple-800/30 transition-all duration-300 z-30 ${
        isCollapsed ? 'w-20' : 'w-64'
      }`}
    >
      <div className="flex flex-col h-full">
        {/* Logo Section */}
        <div className="h-20 flex items-center px-5 border-b border-purple-200/60 dark:border-purple-800/30">
        ...
        {/* Collapse Toggle */}
        <div className="p-3 border-t border-purple-200/60 dark:border-purple-800/30">
          <button
